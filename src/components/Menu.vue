  ...
  <div class="menu">
    <div class="layout">
      <div>
        ...
        <p>Decentralized cloud over web3 technologies for Robotics and IoT.</p>
      </div>
      <nav class="nav">
        <ul class="nav__list">
          <li class="nav__item">
...
<style scoped>
  .menu {
    ...
    transition: transform 0.33s ease-in-out, opacity 0.33s ease-in-out, visibility 0.33s linear;
    /* z-index: 10; */
  }
