          ...
          <div class="discord contacts__item" v-in-viewport.once>
              ...
              <div class="decor-line" v-in-viewport.once aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="125.099" height="38.699" viewBox="0 0 125.099 38.699">
                  <path id="Path_6785" data-name="Path 6785" d="M5597.9,4360l14.625-38.02h110.007" transform="translate(-5597.435 -4321.48)" fill="none" stroke="#fff" stroke-width="1"/>
                </svg>
              </div>
            ...
            <div class="email contacts__item" :class="{active: showForm}">
              <button class="contacts__link" @click="showForm = !showForm">
                <svg xmlns="http://www.w3.org/2000/svg" width="137.213" height="103.16" viewBox="0 0 137.213 103.16">
                  <path id="envelope-solid" d="M123.443,64a12.77,12.77,0,0,1,7.662,22.986L73.215,130.4A8.54,8.54,0,0,1,63,130.4L5.108,86.986A12.77,12.77,0,0,1,12.77,64ZM57.891,137.215a17,17,0,0,0,20.432,0L136.213,93.8v55.337a17.042,17.042,0,0,1-17.027,17.027H17.027A17.034,17.034,0,0,1,0,149.133V93.8Z" transform="translate(0.5 -63.5)" fill="#fff" stroke="#000" stroke-width="0"/>
                </svg>
              </button>
              <div class="decor-line" v-in-viewport.once aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="168.208" height="36.791" viewBox="0 0 168.208 36.791">
                  <path id="Path_6788" data-name="Path 6788" d="M6252.691,4425.08h37.423l9.2-35.791H6420.9" transform="translate(-6252.691 -4388.79)" fill="none" stroke="#fff" stroke-width="1"/>
                </svg>
              </div>
              <div class="contacts__text animate-inside" v-in-viewport.once>
                <span>email </span>
...
export default {
  components: { 
    ContactsForm: () => import("~/components/FooterForm.vue"),
  },
  data() {
    return {
      showForm: false,
